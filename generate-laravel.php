...
<head>
    ...
    <title>Personal Convert - Generate Laravel 4.2</title>
...
<body>
<?php
require('inc/laravel_42_func.php');
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well">
                ...
                <p>Generate Route, Migrate, Controller, Interface, Repository, Request, Model more faster.</p>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="form-stacked">
                ...
                <fieldset>
                    <div class="clearfix">
                        <div class="input">
                            <textarea wrap="soft" class="col-md-12" rows="15" name="txt_interface"
                                      id="txt_interface"><?php echo $resultInterface; ?></textarea>
                        </div>
                    </div>
                    <div class="actions pull-right">
                        <button class="btn btn-lg btn-danger" type="button" onClick="Clear('txt_interface');">
                            Clear
                        </button>
                        <button class="btn btn-lg btn-primary" type="button" onClick="ClipBoard('txt_interface');">
                            Select All
                        </button>
                    </div>
                </fieldset>
